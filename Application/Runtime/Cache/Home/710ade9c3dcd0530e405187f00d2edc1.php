		...
		<script>
			...
			function f1(){
				$.post("/equipment/index.php/Home/Login/do_login", {
					...
					if(text=="pass"){
						window.location.href="/equipment/index.php/Home/Equipment/showclass";
					}else{
						$("#suggest").html(text);
					}
				});
		...
		<div id='main'>
			<div class="contain">
    			...
    			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table>
						<a href="/equipment/Uploads<?php echo ($vo["imagicaddress"]); ?>" target = "_blank"><img src="/equipment/Uploads<?php echo ($vo["imagicaddress"]); ?>" class = "pic" width = "200" height = "200"/> <br><br></a>
						...
						<a href="/equipment/index.php/Home/Equipment/showitems/id/<?php echo ($vo["id"]); ?>">详细信息</a>
						<hr>
