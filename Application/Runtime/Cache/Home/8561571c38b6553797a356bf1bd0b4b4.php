...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/equipment/Public/Css/do_see.css" />
			...
			<div class="contain">
				...
				<div id="show">
					<h2>问题梗概：<?php echo ($find['title']); ?></h2>
							...
							<?php if(($user) == "0"): ?><p><a href="/equipment/index.php/Home/Message/add_answer/id/<?php echo ($find['id']); ?>">回复</a></p><br />
								<?php else: ?> 
