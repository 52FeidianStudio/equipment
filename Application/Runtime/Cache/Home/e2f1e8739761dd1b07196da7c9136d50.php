...
<html>
	<head>
		...
		<link rel="stylesheet" href="/equipment/Public/Css/register.css" />
		<script>
    ...
    <!--END PASSWORD-->	
    <!-- REPAAWORD -->					<input name="repassword" type="password" class="input repassword" value="Repassword" onfocus="this.value=''" />
    <!-- END REPASSWORD -->
    				</div>
    <!--END CONTENT-->
