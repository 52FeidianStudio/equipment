...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/Public/Css/add_message.css" />
	...
	<body>
		...
		<div id='main'>
			<div class="contain">
				<div id="main_navi">
						&nbsp;<a href="/zky/index.php/Home/Index/main">首页</a><span>---></span><a href="/zky/index.php/Home/Message/conmunication">讨论区</a><span>--->发布留言</span>
				...
				<div id="show">
					<?php if(($user) == "0"): ?><form action="/zky/index.php/Home/Message/do_addmessage" method = "post" id = "myForm">
									<br><br>
									<!-- 此处应该限制一下输入文本框的长度 -->
									<h2>留言主题：<input type="title" name="title" name="title"> <br><br></h2>
