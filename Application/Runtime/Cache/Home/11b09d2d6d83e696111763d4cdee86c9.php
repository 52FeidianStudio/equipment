...
<html>
	<head>
		...
		<link rel="stylesheet" type='text/css' href="/zky/Public/Css/regulation.css" />
	...
	<body>
		...
		<div id='footer'>
			<div class="contain">
				...
				<hr />
				<p class="footer_p">@xxxxxxxxxxxxxx  <a href="/zky/index.php/Admin/Index/admin" onclick="f2();">管理</a></p>
			</div>
		</div>
	</body>
</html>