...
<body>
	...
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>仪器编号：<?php echo ($vo["id"]); ?> <br><br>
		...
		<a href="/zky/admin.php/Admin/Equipment/update/id/<?php echo ($vo["id"]); ?>">修改</a>
		<a href="/zky/admin.php/Admin/Equipment/delete/id/<?php echo ($vo["id"]); ?>">删除</a>
