...
<head>
    ...
    <script type="text/javascript" src="/zky/Public/libs/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="/zky/Public/libs/ueditor/ueditor.all.js"></script>
    <script type="text/javascript" src="/zky/Public/libs/jquery/jquery.min.js"></script>
</head>
<body>
