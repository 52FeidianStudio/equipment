...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-10-27 09:29:52
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `tp_equipment` (`id`, `eid`, `ecname`, `eename`, `etype`, `ecmanufactor`, `eemanufactor`, `eoutdate`, `eoutid`, `ebuydate`, `eprice`, `elocation`, `eblong`, `imagicname`, `imagicaddress`, `class`, `introduction`, `count`) VALUES
(36, 0, 'd', '', '', '', '', '', '', '', '', '', '2016-10-26 16:05:54', '1477469154.jpg', './Equipment/2016-10-26/1477469154.jpg', 7, '', 1);
...
(13, 36, '保证卓越性能的同时最大化提升稳定性', 'evo® G2-XS QTof结合采用StepWave™离子光学组件和XS碰撞室技术，保持着一如既往的良好选择性，同时带来灵敏度的显著提升。分析大量样品时，可获取比以往更多、更有意义的组分信息，帮助您全面深入了解样品，制定更可靠的决策。');
...
(9, '2015317200401', '852', 0, '项健健', 0, '2016-10-26 04:10:27'),
(8, '2015317200426', '741', 0, '田尧', 1, '2016-10-26 04:10:20'),
(7, '2015317200416', '789', 0, '占鹏', 1, '2016-10-26 04:10:20'),
(6, '2015317200402', '123', 1, '朱传波', 0, ''),
(11, '2015317200409', '123', 0, '黄海明', 0, '2016-10-26 04:12:38');
